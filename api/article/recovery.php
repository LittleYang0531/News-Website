<?php
	...
	try {
			...
			<body>
				<div class="Main">
					<div>
						...
						<br>
						<br>
						<p>您的文章"'.$article['Title'].'"已被审核员恢复</p>
						<p>可能是由于审核员操作失误导致您的文章被删除</p>
						<p>为您带来不便,深感歉意</p>
						<p></p>
						<br>
		...
		$mail->send();
		if (!$conn->query("UPDATE Article SET banned=0 WHERE ColumnNum=$column and num=$id"))
		{
			echo ReturnError(-400,"请求错误");
			exit;
		}
