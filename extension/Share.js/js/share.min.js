! function(r) {
	...
	function n(r, t, e) {
		...
		var a = i.measureText(e.label).width,
			...
			d = s + u,
			h = .01;
		1 === e.mode ? r.addBlank(0, s - h, n, d + h) : r.addBlank(c - h, s - h, l + h, d + h), t.fillStyle = e
	...
	function o(r, t, e) {
		var n = e.size,
			...
			l = c + a,
			d = .01;
		3 === e.mode ? r.addBlank(0, c - d, n, l + d) : r.addBlank(f - d, c - d, s + d, l + d), t.drawImage(e.image, f *
			n, c * n, u * n, a * n)
	}
	...
	function c(r, t, e, n, o, i, a, c) {
		var s = r.isDark,
			...
			C = s(v, w),
			b = s(a, w);
		m ? u(t, n, o, l, d, h, !y && !b, !y && !A, !k && !A, !k && !b) : f(t, n, o, l, d, h, y && b && T, y && A && E,
			k && A && B, k && b && C)
	}
			...
			var o = 236,
				...
				m = function(r, t) {
					h = 4 * s + 17, d = function(r) {
							...
							return t
						}(h), T(0, 0), T(h - 7, 0), T(0, h - 7), A(), E(), k(r, t), s >= 7 && B(r), null ==
						v && (v = M(s, l, w)), C(v, t)
				},
				T = function(r, t) {
					for (var e = -1; 7 >= e; e += 1)
				...
				var a = function(r) {
					...
					u = function(r) {
						...
						for (d += 1; d < o.length;) {
							...
							d += 1, i.contains(h + g) ? h += g : (l.write(i.indexOf(h), n), i.size() < 4095 && (
	...
	r.fn.share = function(t) {
		function e(t, e) {
			...
			for (var a in "prepend" == e.mode ? n.reverse() : n) {
				var u = n[a],
					f = i(u, e),
					c = e.initialized ? t.find(".icon-" + u) : r('<a class="social-share-icon icon-' + u +
						'" target="_blank"></a>');
		...
		function o(r) {
			...
			var t = u() ? r.mobileSites : r.sites,
				e = r.disabled;
			return "string" == typeof t && (t = t.split(",")), "string" == typeof e && (e = e.split(",")), a() && e
				.push("wechat"), t.filter(function(r) {
